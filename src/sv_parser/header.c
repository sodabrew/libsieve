/* A Bison parser, made from header.y
   by GNU bison 1.32.  */

#define YYBISON 1  /* Identify Bison output.  */

#define yyparse headerparse
#define yylex headerlex
#define yyerror headererror
#define yylval headerlval
#define yychar headerchar
#define yydebug headerdebug
#define yynerrs headernerrs
# define	NAME	257
# define	COLON	258
# define	TEXT	259
# define	WRAP	260
...
{
  "$", "error", "$undefined.", "NAME", "COLON", "TEXT", "WRAP", "headers", 
  "header", "body", NULL
};
#endif
...
{
      -2,     1,     0,-32768,    -3,-32768,-32768,     2,-32768,     4,
  -32768
};
...
#line 56 "header.y"
{
                ...
                headerentry(hl->h, yyvsp[-2], yyvsp[0]);
                }
    break;
case 4:
#line 61 "header.y"
...
#line 65 "header.y"
{
                ...
                yyval = sv_strbuf(ml, sv_strconcat( yyvsp[-1], yyvsp[0], NULL ), strlen(yyvsp[-1])+strlen(yyvsp[0]), FREEME);
                }
    break;
}
